...
* Established baseline documentation for the existing Bash helpers:
  * **bash/run_all_unit_tests.sh/python/run_all_unit_tests.sh**;
  * **bash/run_all_unit_tests.sh/ruby/run_all_unit_tests.sh**;
